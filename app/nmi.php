...
$address1 = trim($_POST["Value3"]);
$address2 = trim($_POST["Value4"]);
$phone = trim($_POST["Value6"]);
$email = trim($_POST["Value7"]);
$city = trim($_POST["Value8"]);
$state = trim($_POST["Field9"]);
$postal_code = trim($_POST["Value5"]);

//var_dump ($firstName,$lastName,$card);


$address3 = trim($_POST["address_3"]);
$city_2 = trim($_POST["city_2"]);
$state_2 = trim($_POST["state_2"]);
$postal_code_2 = trim($_POST["postal_code_2"]);


$product_description_1 = trim($_POST["product_description_1"]);
$product_amount_1 = trim($_POST["product_amount_1"]);
...
$gw = new gwapi;
$gw->setLogin("SunnyADMIN", "DimaPavel1440");
$gw->setBilling($firstName,$lastName,"",$address1,$address2, $city ,$state,$postal_code,"US",$phone,"",$email,"");
$gw->setShipping($firstName,$lastName,"",$address3,"", $city_2,
        $state_2,$postal_code_2,"US","");
$gw->setOrder("1",$product_description_1,1, 2, "PO1234","");

$r = $gw->doSale($product_amount_1,$card,$carddate,$cvv);

//echo $gw->responses['responsetext'];
